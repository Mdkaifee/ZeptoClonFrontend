...
//   return prefs.getString('userId');  // Retrieve stored userId
// }
...
//                   // Navigate to Orders screen and pass dynamic data
...
//                         paymentStatus: 'COD',  // Or 'Paid' depending on your logic
//                         itemStatus: 'Ordered', // Or 'Delivered', 'Cancelled', etc.
//                       ),
//                     ),
//                   );
//                 },
...
Future<String?> _getUserId() async {
  ...
  //     "paymentStatus": "Pending",  // Since it's COD
  //     "orderStatus": "Ordered",   // The order is placed
  //   };

  //   final url = Uri.parse('http://192.168.0.129:5000/api/orders');  // Your API endpoint
